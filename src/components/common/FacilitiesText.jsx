  ...
  <div class="max-w-4xl mx-auto text-center">
    ...
    <div class="rounded-lg overflow-hidden shadow-lg border border-gray-300 h-[400px] md:h-[600px]">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-6 px-6 py-12">
        ...
        <div className="w-full md:w-[600px] bg-gradient-to-r from-purple-500 to-pink-600 p-8 rounded-lg shadow-lg text-center">
          ...
          <ul className="text-white text-sm space-y-2 text-left">
            ...
            <li>1) Free Online Tuition.</li>
            <li>2)Free Legel Support (Only High Court).</li>
            <li>3) Free Job Vacancy(Own Portal & Others).</li>
            <li>4)Discount 20% to 50% for per Rider from QAR(Quick Affordable Rides).</li>
            <li>5) Free High Study Scholarship.</li>
            <li>6) Dicount for KK Raksha Kavach flat 50%.</li>
            <li>7) Free Acting Chances for All Stage.</li>
            <li>8) Discount Flat 70% for All Medicines from QCM Medi & Health Care.</li>
      ...
      <div className="bg-gradient-to-r from-green-500 to-teal-600 p-8 rounded-lg shadow-lg text-center max-w-xl mx-auto">
        ...
        <hr className="border-t-2 border-white mb-4" />
        <ul className="text-white text-sm space-y-2 text-left">
          <li>1) Every Year 92 Top School List</li>
          <li>2) Bengal Top Candidates List</li>
          <li>3) Elite Membership Change & New Set</li>
          <li>4) Offline Exam Live Straming</li>
