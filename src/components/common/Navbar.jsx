...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white py-4 px-6 sticky top-0 left-0 w-full z-50 shadow-sm">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6 text-[17px] font-medium relative">
          ...
          >
            ...
            {isServicesOpen && (
              <div className="absolute top-full left-0 mt-2 w-64 bg-white border rounded-lg shadow-lg z-20">
